...
class AuditionsAppliedScreen extends StatefulWidget {
  @override
  _AuditionsAppliedScreenState createState() => _AuditionsAppliedScreenState();
}

class _AuditionsAppliedScreenState extends State<AuditionsAppliedScreen> {
